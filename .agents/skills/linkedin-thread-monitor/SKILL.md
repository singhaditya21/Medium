...
description: "Review LinkedIn replies and unanswered conversations in signed-in Chrome against the relationship watchlist. State coverage and freshness, identify genuine follow-ups and avoid duplicate responses. Not for engager analysis (use linkedin-engager-analytics), timed DM escalation or automatic sending."
---
