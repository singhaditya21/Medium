...
description: "Draft source-specific LinkedIn comments or proposed reshare commentary using signed-in Chrome context. Check prior activity and present exact actions for approval. Not for replies to existing comments (use linkedin-reply-handler)."
---
