...
description: "Draft evidence-backed LinkedIn posts with a clear opening, technical argument and suitable format. Use hook structures as editorial options, not reach guarantees. Present exact wording and media/settings for approval. Not for reviewing an existing draft (use linkedin-humanizer)."
---
