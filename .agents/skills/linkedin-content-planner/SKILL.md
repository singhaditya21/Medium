...
description: "Prepare a LinkedIn weekly or monthly editorial plan from the account's audience, content pillars, catalog and existing scheduled posts. Propose gaps and formats without changing schedules. Not for drafting one post (use linkedin-post-writer)."
---
