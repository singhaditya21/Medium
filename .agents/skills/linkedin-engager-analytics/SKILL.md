...
description: "Review observed engagement on the user's LinkedIn posts through signed-in Chrome. Identify relevant relationships and evidence gaps without scraping or inferring buying intent from likes. Not for thread follow-ups (use linkedin-thread-monitor)."
---
