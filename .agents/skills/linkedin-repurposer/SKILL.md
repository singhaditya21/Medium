...
description: "Adapt an owned story, newsletter, video or other existing content into a LinkedIn-native draft while preserving its facts. Propose link and media placement for approval. Not for writing from scratch (use linkedin-post-writer) or silent changes to scheduled posts."
---
