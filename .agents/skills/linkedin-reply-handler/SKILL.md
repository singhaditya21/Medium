...
description: "Draft a reply to an existing LinkedIn comment after reading the post, parent thread and prior user activity in signed-in Chrome. Answer direct questions and show the exact reply target for approval. Not for top-level comments (use linkedin-comment-drafter)."
---
